...
public class MainServlet extends HttpServlet {
  ...
  @Override
  public void init() {
    final ApplicationContext applicationContext = new AnnotationConfigApplicationContext("ru.netology");
    final PostRepository repository = applicationContext.getBean(PostRepository.class);
    final PostService service = applicationContext.getBean(PostService.class);
